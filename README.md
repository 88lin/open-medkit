...
| **过期自动提醒** | 到期 / 即将到期药品自动标记高亮，支持 [Telegram / Discord / 飞书 / Email](./NOTIFICATIONS.md) 每日推送 |
...
各渠道的详细配置步骤、常见邮箱参数和故障排查请参阅 **[NOTIFICATIONS.md](./NOTIFICATIONS.md)**。
...
- Notification reminders (Telegram / Discord / Lark(Feishu) / Email) send medicine names, expiry dates, and reminder text to the corresponding platform once that channel is enabled.
...
│       ├── services/  # Telegram, Discord, Lark(Feishu), Email & notification scheduler
